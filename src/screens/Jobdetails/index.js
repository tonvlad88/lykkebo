...
// Actions
import { getJobDetails, updateWorkingDay } from '../../redux/actions/jobDetails';
...
class JobdetailsScreen extends Component {
  ...
  render() {
    const {
      userRelation, isFromTimeRec, showSpecifyModal, userId,
    } = this.state;
    ...
    return (
      <Container style={styles.container}>
        ...
        <Header style={{ backgroundColor: '#2E3D43' }}>
          ...
          <Body style={{flex: 1}}>
            <Title numberOfLines={1} style={{textAlign: 'center', color: 'white'}}>
              { datas.booking.title }
            </Title>
          </Body>
          <Right>
        ...
        <Content>
          ...
          <Modal isVisible={showSpecifyModal}>
            <View style={{borderRadius: 5, flex: 1, backgroundColor: '#E8E8E8'}}>
              <Header noShadow noRight style={{backgroundColor: '#F0F0F0'}}>
                ...
                <Body style={{flex: 3}}>
                  <Text
                    style={{
                      textAlign: 'center', width: '100%', fontWeight: 'bold', fontSize: 25,
                    }}>
                    Arbejdsdage
                  </Text>
                </Body>
