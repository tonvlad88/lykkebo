...
export async function modelFetchTracker(userId, date) {
  ...
  console.log(
    `${baseUrl}/lykkebo/v1/timerec/overview/test?user_id=${userId}&day=${date}`
  );
  return fetch(
    `${baseUrl}/lykkebo/v1/timerec/overview/test?user_id=${userId}&day=${date}`,
    {
...
export async function modelsaveDailyNote(data) {
  ...
  axios
    .post(
      `${baseUrl}/lykkebo/v1/timerec/submitInternalTimeRecording`,
      data,
      axiosConfig
    )
    .then((res) => {
...
export async function deleteNoteTrackerDetailsData(data) {
  ...
  axios
    .post(`${baseUrl}/lykkebo/v1/timerec/delete`, data, axiosConfig)
    .then((res) => res.data)
    .catch((error) => {
      console.log("error", "modelsaveDailyNote");
    });
...
export async function updateNoteTrackerDetailsData(data) {
  ...
  axios
    .post(`${baseUrl}/lykkebo/v1/timerec/update`, data, axiosConfig)
    .then((res) => res.data)
    .catch((error) => {
